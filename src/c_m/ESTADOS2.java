...
public class ESTADOS2 extends javax.swing.JFrame {
//Generamos la matriz para las condiciones
Float[][] c = new Float[1][XN];
...
ArrayList arr = new ArrayList();
    ...
    public ESTADOS2() {
        ...
        //NUEVO
        DefaultTableModel mode35 = (DefaultTableModel) SOL.getModel();
        DefaultTableModel model6 = (DefaultTableModel) jTable3.getModel();
        ...
        model6.addColumn("");
        for(int i = 0;i<XN;i++){
        model.addColumn(V_N[i]);model5.addColumn(V_N[i]);model2.addColumn(V_N[i]);mode35.addColumn(V_N[i]);
        model6.addColumn(V_N[i]);}
        ...
        MyCellrendar3.setBackground(new Color(242, 242, 242));
        ...
        for(int i=1;i<XN+1;i++){
                ...
                ER.getColumnModel().getColumn(i).setCellRenderer(MyCellrendar2);
        MyCellrendar2.setHorizontalAlignment(SwingConstants.CENTER);
                Condiciones.getColumnModel().getColumn(i-1).setCellRenderer(MyCellrendar2);
    ...
    private void initComponents() {
        ...
        Condiciones.getTableHeader().setResizingAllowed(false);
        Condiciones.getTableHeader().setReorderingAllowed(false);
        ...
        SOL.getTableHeader().setResizingAllowed(false);
        SOL.getTableHeader().setReorderingAllowed(false);
...
//EL SIGUEINTE MODULO REALIZA TODOS LOS CALCULOS
    ...
    try{for(int i =0;i<XN;i++){
            c[0][i]=Float.parseFloat(Condiciones.getValueAt(0, i).toString());
    }
    ...
    //En esta sección se pasan todos los valores generaados a las tablas para su visualización
      ...
      Object rowData3[] = new Object [XN+1];
      rowData3[0]="EST E";
     for(int i =0;i<XN;i++){
      rowData3[i+1]=Matrizi[0][i];
    }
    ...
    MyCellrendar4.setBackground(new Color(242, 242, 242));
    SOL.getColumnModel().getColumn(0).setCellRenderer(MyCellrendar4);
    DefaultTableCellRenderer MyCellrendar5 = new DefaultTableCellRenderer();
    MyCellrendar5.setBackground(Color.YELLOW);
    for(int i=1;i<XN+1;i++){
    SOL.getColumnModel().getColumn(i).setCellRenderer(MyCellrendar5);}
        for(int i=1;i<XN+1;i++){
        MyCellrendar5.setHorizontalAlignment(SwingConstants.CENTER);
                SOL.getColumnModel().getColumn(i).setCellRenderer(MyCellrendar5);
        }
...
public void eliminar2(){
    ...
    MyCellrendar5.setBackground(Color.YELLOW);
    for(int i=1;i<XN+1;i++){
    jTable3.getColumnModel().getColumn(i).setCellRenderer(MyCellrendar5);}
        for(int i=1;i<XN+1;i++){
        MyCellrendar5.setHorizontalAlignment(SwingConstants.CENTER);
                jTable3.getColumnModel().getColumn(i).setCellRenderer(MyCellrendar5);
        }    
      ...
      for(int i =0;i<XN;i++){
      rowData3[i+1]=Matrizi[0][i];
    }model3.addRow(rowData3); }catch(Exception e){
 ...
 DefaultTableCellRenderer MyCellrendar = new DefaultTableCellRenderer();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ESTADOS2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
